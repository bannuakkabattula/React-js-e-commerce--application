...
const HomeOnepageScroll = () => {
  ...
  return (
    <Fragment>
      <MetaTags>
        <title>Yoda Pharmacy | Fashion Home</title>
        <meta
          name="description"
          content="Fashion home of Yoda Pharmacy react minimalist eCommerce template."
        />
      </MetaTags>
        ...
        <SectionsContainer {...options} className="bg-purple-2">
          {sliderData &&
            sliderData.map((single, key) => {
              return (
                <Section key={key}>
                  <div className="slider-section Yoda Pharmacy-fp-section">
